        ...
        <div class="a2book">
            <form action="<c:url value='/admin/BookServlet'/>" method="post">
                <fieldset>
                    ...
                    <p><label>书名：<input type="text" name="bname" value="${oriBook.bname}"></label></p>
                    <p><label>作者：<input type="text" name="author" value="${oriBook.author}" placeholder="多个作者之间用英文逗号隔开"></label></p>
                    <p><label>出版社：<input type="text" name="publish" value="${oriBook.publish}"></label></p>
                    <p><label>出版日期：<input type="text" name="pubdate" value="${oriBook.pubdate}" placeholder="格式：2018.9"></label></p>
                    <p><label>类型：<input type="text" name="btype" value="${oriBook.btype}"></label></p>
                    <p><label>存放编号：<input type="text" name="bindex" value="${oriBook.bindex}"></label></p>
                    <p class="center"><input type="reset"><input type="submit" value="提交"></p>
                    <p><span style="color:red;font-size:30px;">${addBookMeg }</span></p>
                </fieldset>
            </form>
        </div>
    </div>

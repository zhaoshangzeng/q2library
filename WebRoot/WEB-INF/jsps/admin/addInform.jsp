...
<div class="wrap">
    ...
    <div class="content">
        ...
        <form action="<c:url value='/admin/InformServlet'/>" method="post">
        	<input type="hidden" name="method" value="addInform"/>
            <label>通知的标题：<input type="text" name="title" value=${oriInform.title}></label><br/>
            <div>通知内容:</div>
            <label><textarea name="content" cols="100" rows="10" value=${oriInform.content}></textarea></label><br/>
            <input type="reset"><input type="submit" value="提交">
            <p><span style="color:red;font-size:30px;">${addInformMeg}</span></p>
        </form>
    	</div>
    </div>
</div>

...
<div class="wrap">
    ...
    <div class="content">
        ...
        <div class="upAccount">
            <form action="<c:url value='/admin/AccountServlet'/>" method="post">
                <fieldset>
                    <legend>修改密码</legend>
                    <input type="hidden" name="method" value="updatePassword"/>
                    <p><label>原密码：<input type="password" name="oripass"></label></p>
                    <p><label>新密码：<input type="password" name="newpass" placeholder="6-10位数字或字母，区分大小写" maxlength="10" id="newpass" onblur="jy()"></label></p>
                    <p><label>确认密码：<input type="password" name="confirm" id="confirm" onblur="jy2()"></label></p>
                    <p class="center"><input type="reset"><input type="submit"></p>
                </fieldset>
                <span style="color:red;font-size:30px;">${accountMeg}</span>
            </form>
            <script>
            	function jy(){
